...
VPA + CBD Hepatotoxicity
Mechanisms, Monitoring, and the Untested
Mitochondrial Convergence Hypothesis
...
Valproylcarnitine formation and renal excretion
Inhibition of endogenous carnitine biosynthesis
...
Dose: Use 10 mg/kg/day CBD rather than 20 mg/kg/day when possible. ALT >3× ULN incidence drops from ~21% to ~1% at the lower dose.
Monitoring: Follow the EMA’s more intensive schedule: 2 weeks, 1, 2, 3, and 6 months. Monitor ammonia alongside transaminases per the 2025 label update.
L-Carnitine: Supplement at 100 mg/kg/day (maximum 2 g/day) for young children on VPA polytherapy (Pediatric Neurology Advisory Committee recommendation).
POLG Screening: Consider testing in patients with developmental regression or family history of mitochondrial disease.
Discontinuation: ALT >3× ULN with bilirubin >2× ULN, or sustained transaminases >5× ULN.
...
Measure GDF15/FGF21 in VPA + CBD patients who develop transaminase elevations to confirm or exclude mitochondrial involvement.
Assess VPA-pretreated hepatocytes for enhanced sensitivity to CBD-induced mitochondrial depolarization in vitro.
Test VDAC1 inhibition or N-acetylcysteine supplementation as protective interventions against the synergistic toxicity.
